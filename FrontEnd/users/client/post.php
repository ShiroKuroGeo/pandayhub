...
<body>
    <div class="container-fluid bg-white p-0 vh-100" id="postHub">
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div :class="pandaysLength < 1 ? 'visually-hidden mb-5' : 'mb-5'">
                    <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">My Panday Post</h1>
                    <div class="row g-4">
                        <div class="col-lg-4 col-sm-6 wow fadeInUp" v-for="p of pandays" data-wow-delay="0.1s">
                ...
                <hr>
                <div :class="jobLength < 1 ? 'visually-hidden my-5' : 'mb-5'">
                    <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">My Job Post</h1>
                    <div class="row g-4">
                        <div class="col-lg-4 col-sm-6 wow fadeInUp" v-for="p of job" data-wow-delay="0.1s">
                            <div class="cat-item rounded p-4" href="">
                                <img :src="'/pandayhub/assets/img/'+p.image" style="width: 150px; height: 150px" class="rounded p-3" alt="">
                                <h6 class="mb-3">Title: {{p.title}}</h6>
                                <h6 class="text-muted">Project Type: {{p.projectType}}</h6>
                                <h6 class="text-muted">Job Project: {{p.job_project}}</h6>
                                <p class="mb-0">
                                    <button class="btn btn-sm me-2 col-2 btn-primary" data-bs-toggle="modal" @click="getId(p.id)" data-bs-target="#deleteJob">
                                        <i class="bi bi-trash"></i>
                                    </button>
                                    <button class="btn btn-sm me-2 col-2 btn-primary" data-bs-toggle="modal" @click="getAllSelectedJob(p.id)" data-bs-target="#updateJob">
                                        <i class="bi bi-eye"></i>
                                    </button>
                                </p>
                            </div>
